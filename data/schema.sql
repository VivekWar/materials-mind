...
CREATE TABLE IF NOT EXISTS materials (
    ...
    -- All physical/mechanical/thermal/electrical properties are stored here
    specific_properties      JSONB,
...
-- ----------------------------------------------------------------
-- JSONB Property Indexes for fast filtering (using B-tree on extracted float values)
CREATE INDEX IF NOT EXISTS idx_mat_density         ON materials(((specific_properties->>'density')::float));
CREATE INDEX IF NOT EXISTS idx_mat_tg              ON materials(((specific_properties->>'glass_transition_temp')::float));
CREATE INDEX IF NOT EXISTS idx_mat_hdt             ON materials(((specific_properties->>'heat_deflection_temp')::float));
CREATE INDEX IF NOT EXISTS idx_mat_melting_pt       ON materials(((specific_properties->>'melting_point')::float));
CREATE INDEX IF NOT EXISTS idx_mat_thermal_cond     ON materials(((specific_properties->>'thermal_conductivity')::float));
CREATE INDEX IF NOT EXISTS idx_mat_resistivity      ON materials(((specific_properties->>'electrical_resistivity')::float));
CREATE INDEX IF NOT EXISTS idx_mat_yield_strength   ON materials(((specific_properties->>'yield_strength')::float));
CREATE INDEX IF NOT EXISTS idx_mat_youngs_modulus   ON materials(((specific_properties->>'youngs_modulus')::float));
